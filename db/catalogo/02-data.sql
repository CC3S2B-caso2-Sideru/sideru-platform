...
INSERT INTO producto (categoria_id, sku, nombre, descripcion, precio, stock, stock_minimo, imagen) VALUES
    ...
    (1, 'BAR-COR-6MM',  'Varilla corrugada 6mm x 9m',   'Acero corrugado grado 60, barra de 9 metros',  18.50,  850, 100, NULL),
    (1, 'BAR-COR-8MM',  'Varilla corrugada 8mm x 9m',   'Acero corrugado grado 60, barra de 9 metros',  28.90,  620, 100, NULL),
    (1, 'BAR-COR-12MM', 'Varilla corrugada 12mm x 9m',  'Acero corrugado grado 60, barra de 9 metros',  58.00,  430,  80, NULL),
    (1, 'BAR-LIS-16MM', 'Barra lisa 16mm x 6m',         'Acero liso SAE 1020, barra de 6 metros',       42.00,  200,  50, NULL),
    (2, 'PER-ANG-2X2',  'Ángulo 2"x2"x3/16" x 6m',     'Ángulo de acero A36',                         55.00,  310,  60, NULL),
    (2, 'PER-VIG-4',    'Viga H 4" x 13lb/pie x 6m',   'Viga de acero estructural A36',               195.00,  120,  30, NULL),
    (2, 'PER-CAN-3',    'Canal C 3" x 5lb/pie x 6m',   'Canal de acero A36',                           88.00,  180,  40, NULL),
    (3, 'PLA-CAL-2MM',  'Plancha laminada caliente 2mm','Plancha LAC 1.22m x 2.44m',                   210.00,  95,  20, NULL),
    (3, 'PLA-GAL-1MM',  'Plancha galvanizada 1mm',      'Plancha galvanizada 1.22m x 2.44m, Z275',    185.00,  140,  25, NULL),
    (4, 'TUB-NEG-1',    'Tubo negro 1" x 6m',           'Tubo negro ERW ASTM A53',                      38.00,  500,  80, NULL),
    (4, 'TUB-GAL-3_4',  'Tubo galvanizado 3/4" x 6m',  'Tubo galvanizado ASTM A53',                    44.00,  380,  80, NULL),
    (5, 'ALA-REC-16',   'Alambre recocido N°16 x 30kg', 'Rollo de alambre recocido calibre 16',         98.00,  220,  50, NULL),
    (5, 'MAL-ELS-15',   'Malla electrosoldada 15x15cm', 'Panel 2.4m x 6m, alambre 4mm',               145.00,   75,  20, NULL);
